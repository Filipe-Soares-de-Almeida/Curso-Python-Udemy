...
#     estrutura_classe = super().__new__(mcs, name, bases, dct)
#     return estrutura_classe

#   def __call__(cls, *args, **kwargs):
#     print('MEU CALL - METACLASS')

#     instancia_classe = super().__call__(*args, **kwargs)
...
#     print('MEU NEW')
#     instancia_classe = super().__new__(cls)
#     return instancia_classe
